...
{
    /// <inheritdoc />
    public partial class AddInductionTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowForAllCollaborators = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Induction_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InductionFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InductionFiles_Induction_InductionId",
                        column: x => x.InductionId,
                        principalTable: "Induction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Induction_CompanyId",
                table: "Induction",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_InductionFiles_InductionId",
