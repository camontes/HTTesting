...
{
    /// <inheritdoc />
    public partial class AddCoexistenceCommitteeMinuteTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CoexistenceCommitteeMinutes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoexistenceCommitteeMinutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoexistenceCommitteeMinutes_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoexistenceCommitteeMinutes_CompanyId",
                table: "CoexistenceCommitteeMinutes",
                column: "CompanyId");
        }
