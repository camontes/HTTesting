...
{
    /// <inheritdoc />
    public partial class CollaboratorStateTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollaboratorStates", x => x.Id);
                });

            migrationBuilder.InsertData(
                table: "CollaboratorStates",
