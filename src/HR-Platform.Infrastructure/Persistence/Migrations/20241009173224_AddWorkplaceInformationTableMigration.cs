...
{
    /// <inheritdoc />
    public partial class AddWorkplaceInformationTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "WorkplaceInformations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkplaceInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkplaceInformations_Collaborators_CollaboratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkplaceInformations_CollaboratorId",
                table: "WorkplaceInformations",
