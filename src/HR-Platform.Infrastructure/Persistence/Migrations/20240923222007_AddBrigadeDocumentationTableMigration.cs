...
{
    /// <inheritdoc />
    public partial class AddBrigadeDocumentationTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrigadeDocumentations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrigadeDocumentations_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrigadeDocumentations_CompanyId",
                table: "BrigadeDocumentations",
                column: "CompanyId");
        }
