...
{
    /// <inheritdoc />
    public partial class AddOccupationalRecommendationTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "OccupationalRecommendations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OccupationalRecommendations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OccupationalRecommendations_Collaborators_CollaboratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OccupationalRecommendations_CollaboratorId",
                table: "OccupationalRecommendations",
