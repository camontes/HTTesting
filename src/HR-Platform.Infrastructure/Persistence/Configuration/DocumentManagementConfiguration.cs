...
public class DocumentManagementConfiguration : IEntityTypeConfiguration<DocumentManagement>
{
    public void Configure(EntityTypeBuilder<DocumentManagement> builder)
    {
        ...
        builder.Property(c => c.Id).HasConversion(
            DefaultDocumentManagementId => DefaultDocumentManagementId.Value,
            value => new DocumentManagementId(value)
        );

        builder.HasOne(p => p.Collaborator).WithMany(c => c.DocumentManagements).HasForeignKey(c => c.CollaboratorId);

        builder.HasOne(c => c.DocumentManagementFileType).WithMany(p => p.DocumentManagements).HasForeignKey(c => c.DocumentManagementFileTypeId);
        ...
        builder.Property(c => c.DocumentManagementFileTypeId);
