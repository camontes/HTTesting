...
public class EmergencyContactConfiguration : IEntityTypeConfiguration<EmergencyContact>
{
    public void Configure(EntityTypeBuilder<EmergencyContact> builder)
    {
        ...
        builder.Property(c => c.Id).HasConversion(
            DefaultEmergencyContactId => DefaultEmergencyContactId.Value,
            value => new EmergencyContactId(value)
        );

        builder.HasOne(c => c.Collaborator).WithMany(p => p.EmergencyContacts).HasForeignKey(c => c.CollaboratorId);
