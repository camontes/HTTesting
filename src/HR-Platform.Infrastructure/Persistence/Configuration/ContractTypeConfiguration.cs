...
public class ContractTypeConfiguration : IEntityTypeConfiguration<ContractType>
{
    public void Configure(EntityTypeBuilder<ContractType> builder)
    {
        ...
        builder.Property(c => c.Id).HasConversion(
            ...
            value => new ContractTypeId(value)
        );

        builder.HasOne(p => p.Company).WithMany(c => c.ContractTypes).HasForeignKey(c => c.CompanyId);
        ...
        builder.HasMany(p => p.CollaboratorContracts)
