...
[Route("FileType")]
public class FileType(ISender mediator) : ApiController
{
    ...
    public async Task<IActionResult> GetAllNames()
    {
        ...
        ErrorOr<IReadOnlyList<FileTypesResponse>> FileTypeResult = await _mediator.Send(new GetAllFileTypesQuery());

        return FileTypeResult.Match(
