...
public class WorkplaceEvidenceSearchFilterQuery(string query, int page, int pageSize, string collaboratorEmail, string? year) : SearchFilterQueryBase, IRequest<ErrorOr<SearchFilterResponse>>
{
