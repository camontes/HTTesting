...
internal sealed class GetNoveltyByCollaboratorIdQueryHandler(
    ICollaboratorRepository collaboratorRepository,
    IAreaRepository areaRepository,
    ITimeFormatService timeFormatService,
    IFormAnswerRepository formAnswerRepository
    ) : IRequestHandler<GetNoveltyByCollaboratorIdQuery, ErrorOr<List<NoveltyByCollaboratorResponse>>>
{
    ...
    public async Task<ErrorOr<List<NoveltyByCollaboratorResponse>>> Handle(GetNoveltyByCollaboratorIdQuery query, CancellationToken cancellationToken)
    {
        ...
        SearchFilter<FormAnswer>? formAnswer
            =
            await _formAnswerRepository.GetByCollaboratorIdAndNameSearchAsync
            (
