...
public class InductionsSentSearchFilterQuery(string query, int page, int pageSize, Guid companyId) : SearchFilterQueryBase, IRequest<ErrorOr<SearchFilterResponse>>
{
