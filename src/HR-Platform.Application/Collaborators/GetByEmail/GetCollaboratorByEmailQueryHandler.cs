...
internal sealed class GetCollaboratorByEmailQueryHandler(
    ICollaboratorRepository collaboratorRepository,

    IStringService stringService,
    ITimeFormatService timeFormatService
    ) : IRequestHandler<GetCollaboratorByEmailQuery, ErrorOr<CollaboratorsResponse>>
{
    ...
    public async Task<ErrorOr<CollaboratorsResponse>> Handle(GetCollaboratorByEmailQuery query, CancellationToken cancellationToken)
    {
