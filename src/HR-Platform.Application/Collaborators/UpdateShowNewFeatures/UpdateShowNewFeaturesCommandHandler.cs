...
internal sealed class UpdateShowNewFeaturesCommandHandler(
    ...
    ) : IRequestHandler<UpdateShowNewFeaturesCommand, ErrorOr<CollaboratorsResponse>>
{
    ...
    public async Task<ErrorOr<CollaboratorsResponse>> Handle(UpdateShowNewFeaturesCommand query, CancellationToken cancellationToken)
    {
        ...
        oldCollaborator.ShowNewFeatures = query.ShowNewFeatures;
