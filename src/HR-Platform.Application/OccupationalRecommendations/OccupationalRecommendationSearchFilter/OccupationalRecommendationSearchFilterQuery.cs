...
public class OccupationalRecommendationSearchFilterQuery(string query, int page, int pageSize, string collaboratorEmail, string? year) : SearchFilterQueryBase, IRequest<ErrorOr<SearchFilterResponse>>
{
